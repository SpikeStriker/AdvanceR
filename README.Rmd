...
The goal of elucideanDistanceToNode is to ...

## Installation

You can install the development version of elucideanDistanceToNode from [GitHub](https://github.com/) with:

``` r
# install.packages("pak")
pak::pak("SpikeStriker/AdvanceR")
```
